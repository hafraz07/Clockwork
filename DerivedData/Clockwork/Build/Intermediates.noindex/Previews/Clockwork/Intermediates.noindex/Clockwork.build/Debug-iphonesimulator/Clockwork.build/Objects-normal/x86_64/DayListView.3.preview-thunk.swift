                ...
                if (!userData.days.isEmpty) {
                    __designTimeSelection(List {
                        __designTimeSelection(ForEach(__designTimeSelection(userData.days, "#5204.[1].[1].property.[0].[0].arg[0].value.[0].arg[1].value.[0].[0].[0].arg[0].value.[0].arg[0].value")) { day in
                            __designTimeSelection(NavigationLink(destination: __designTimeSelection(HistoryListView(day: __designTimeSelection(day, "#5204.[1].[1].property.[0].[0].arg[0].value.[0].arg[1].value.[0].[0].[0].arg[0].value.[0].arg[1].value.[0].arg[0].value.arg[0].value")), "#5204.[1].[1].property.[0].[0].arg[0].value.[0].arg[1].value.[0].[0].[0].arg[0].value.[0].arg[1].value.[0].arg[0].value")) {
...
//                NavigationLink(destination: HistoryListView()) {
                    __designTimeSelection(Image(systemName: __designTimeString("#5204.[1].[1].property.[0].[0].arg[0].value.[0].arg[1].value.[1].arg[0].value.[0].value", fallback: "plus.circle.fill"))
                        .resizable()
                        .scaledToFit()
                        ...
                        .onTapGesture {
                            __designTimeSelection(self.userData.days.append(__designTimeSelection(Day(), "#5204.[1].[1].property.[0].[0].arg[0].value.[0].arg[1].value.[1].modifier[5].arg[0].value.[0].modifier[0].arg[0].value")), "#5204.[1].[1].property.[0].[0].arg[0].value.[0].arg[1].value.[1].modifier[5].arg[0].value.[0]")
